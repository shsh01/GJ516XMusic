...
from GJ516X.utils.database import get_authuser_names, get_cmode
from GJ516X.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from GJ516X.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await GJ516.stop_stream(message.chat.id)
    except:
        pass
